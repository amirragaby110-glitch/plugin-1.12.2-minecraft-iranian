...
public class IranianHardcorePlugin extends JavaPlugin {
    ...
    private ir.iranian.hardcore.calendar.PersianEventManager persianEventManager;
    private ir.iranian.hardcore.currency.CoinManager coinManager;
    private ir.iranian.hardcore.civilization.CivilizationManager civilizationManager;
    private ir.iranian.hardcore.army.ArmyManager armyManager;
    private ir.iranian.hardcore.underground.UndergroundChestManager undergroundChestManager;
    private ir.iranian.hardcore.gui.ArmyGUI armyGUI;
    private ir.iranian.hardcore.gui.CalendarGUI calendarGUI;
    private ir.iranian.hardcore.gui.CivilizationGUI civilizationGUI;
    ...
    public void onEnable() {
        ...
        // Ancient Persian Systems - v5.4
        persianEventManager = new ir.iranian.hardcore.calendar.PersianEventManager(this);
        coinManager = new ir.iranian.hardcore.currency.CoinManager(this);
        civilizationManager = new ir.iranian.hardcore.civilization.CivilizationManager(this);
        armyManager = new ir.iranian.hardcore.army.ArmyManager(this);
        undergroundChestManager = new ir.iranian.hardcore.underground.UndergroundChestManager(this);
        armyGUI = new ir.iranian.hardcore.gui.ArmyGUI(this);
        calendarGUI = new ir.iranian.hardcore.gui.CalendarGUI(this);
        civilizationGUI = new ir.iranian.hardcore.gui.CivilizationGUI(this);
    ...
    public void onDisable() {
        ...
        if (civilizationManager != null) {
            civilizationManager.saveData();
        }
        if (armyManager != null) {
            armyManager.saveData();
        }
    ...
    private void registerCommands() {
        ...
        if (getCommand("army") != null) {
            ir.iranian.hardcore.commands.ArmyCommand armyCommand = new ir.iranian.hardcore.commands.ArmyCommand(this);
            getCommand("army").setExecutor(armyCommand);
        }
        if (getCommand("calendar") != null) {
            ir.iranian.hardcore.commands.CalendarCommand calCommand = new ir.iranian.hardcore.commands.CalendarCommand(this);
            getCommand("calendar").setExecutor(calCommand);
        }
        if (getCommand("civilization") != null) {
            ir.iranian.hardcore.commands.CivilizationCommand civCommand = new ir.iranian.hardcore.commands.CivilizationCommand(this);
            getCommand("civilization").setExecutor(civCommand);
        }
        getLogger().info("Commands registered (race + hardcore + dungeon + bazaar + iranian + army + calendar + civilization)");
    }
    ...
    public ir.iranian.hardcore.items.PersianAuthenticItems getAuthenticItems() { return authenticItems; }
    public ir.iranian.hardcore.pahlavani.ZoorkhanehManager getZoorkhanehManager() { return zoorkhanehManager; }
    public ir.iranian.hardcore.structures.AtashkadehBahram getAtashkadehBahram() { return atashkadehBahram; }
    public ir.iranian.hardcore.mobs.AkvanDivBoss getAkvanDivBoss() { return akvanDivBoss; }
    public ir.iranian.hardcore.calendar.PersianEventManager getPersianEventManager() { return persianEventManager; }
    public ir.iranian.hardcore.currency.CoinManager getCoinManager() { return coinManager; }
    public ir.iranian.hardcore.civilization.CivilizationManager getCivilizationManager() { return civilizationManager; }
    public ir.iranian.hardcore.army.ArmyManager getArmyManager() { return armyManager; }
    public ir.iranian.hardcore.underground.UndergroundChestManager getUndergroundChestManager() { return undergroundChestManager; }
    public ir.iranian.hardcore.gui.ArmyGUI getArmyGUI() { return armyGUI; }
    public ir.iranian.hardcore.gui.CalendarGUI getCalendarGUI() { return calendarGUI; }
    public ir.iranian.hardcore.gui.CivilizationGUI getCivilizationGUI() { return civilizationGUI; }
}
